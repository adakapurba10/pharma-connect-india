...
object GeminiClient {
    ...
    suspend fun askGemini(prompt: String, systemPrompt: String? = null): String {
        ...
        if (apiKey.isEmpty() || apiKey == "MY_GEMINI_API_KEY") {
            return "Gemini API key is not configured in the Secrets panel. Please configure it to get live AI responses."
        }
        ...
        return try {
            ...
            "API Error: ${e.localizedMessage ?: "Unknown network error. Check your internet connection."}"
        }
    }
}
